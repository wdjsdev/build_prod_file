...
// 	var garPat = /[fp][ds][-_]/i;
// 	var curLine, curItem, curGarment = {};
// 	var curSize, curCode, itemText;

// 	for (var x = 0, len = curOrderData.lines.length; x < len; x++)
// 	{
// 		curLine = curOrderData.lines[x];
// 		itemText = curLine.item;
// 		if (garPat.test(itemText))
// 		{
// 			log.l(itemText + " appears to be a correctly formatted garment");
// 			if (!curItem)
// 			{
// 				curItem = itemText.substring(0, itemText.indexOf(" : "));
// 				log.l("The variable curItem was not yet defined. setting curItem to " + curItem);
// 			}
// 			if (itemText !== curItem)
// 			{
// 				log.l(itemText + " !=== " + curItem + ". Pushing curGarment to garmentsNeeded array and re-initializing.\n");
// 				garmentsNeeded.push(curGarment);
// 				curGarment = {};
// 				curGarment.roster = {};
// 				curItem = itemText;
...
// 			curSize = itemText.substring(itemText.lastIndexOf("-") + 1, itemText.length);
// 			log.l("Set curSize to " + curSize);
// 			if (curItem === itemText)
// 			{
// 				log.l(curItem + " === " + itemText + ". adding the roster info for " + curSize);
// 				curGarment.item = itemText;
// 				curGarment.roster[curSize] = [];
// 				for (var y = 0, ylen = curLine.memo.roster.length; y < ylen; y++)
// 				{
// 					curGarment.roster[curSize].push({
...
// 		else
// 		{
// 			log.l(itemText + " does NOT appear to be a correctly formatted garment. Skipping it.");
// 			curGarment = {};
// 			curItem = undefined;
// 		}
// 	}
// 	log.l("splitDataByGarment function returning: " + result);
// 	return result;
// }